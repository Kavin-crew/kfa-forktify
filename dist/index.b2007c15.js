...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var L=Function.prototype.call;j=O?L.bind(L):function(){return L.apply(L,arguments)};var M={}.propertyIsEnumerable,x=Object.getOwnPropertyDescriptor;n=x&&!M.call({1:2},1)?function(e){var t=x(this,e);return!!t&&t.enumerable}:M;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var T={},I={},q={},H=Function.prototype,F=H.call,N=O&&H.bind.bind(F,F),A={},D=(q=O?N:function(e){return function(){return F.apply(e,arguments)}})({}.toString),C=q("".slice);A=function(e){return C(D(e),8,-1)};var R=Object,W=q("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
eO=function(e){return eL(U(e))};var eM=q({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ej=Object.hasOwn||function(e,t){return eM(eO(e),t)};var ex={},eP=0,eT=Math.random(),eI=q(1..toString);ex=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eI(++eP+eT,36)};var eq=k.Symbol,eH=e_("wks"),eF=en?eq.for||eq:eq&&eq.withoutSetter||ex,eN=TypeError,eA=(ej(eH,e="toPrimitive")||(eH[e]=ei&&ej(eq,e)?eq[e]:eF("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
Y=function(e,t){if(!J(e)||ee(e))return e;var r,n=ef(e,eA);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!J(r)||ee(r))return r;throw eN("Can't convert object to primitive value")}return void 0===t&&(t="number"),em(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
B=function(e){var t=Y(e,"string");return ee(t)?t:t+""};var eD={},eC={},eR=k.document,eW=J(eR)&&J(eR.createElement);eC=function(e){return eW?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
eD=!S&&!$(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var eU=Object.getOwnPropertyDescriptor;r=S?eU:function(e,t){if(e=T(e),t=B(t),eD)try{return eU(e,t)}catch(e){}if(ej(e,t))return P(!j(n,e,t),e[t])};var eG={},ez={};// V8 ~ Chrome 36-
...
for(;t.length>i;)ej(n,r=t[i++])&&(~tI(o,r)||tq(o,r));return o};var tH=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");l=Object.getOwnPropertyNames||function(e){return tw(e,tH)},d=Object.getOwnPropertySymbols;var tF=q([].concat);// all object keys, includes non-enumerable and symbols
t_=et("Reflect","ownKeys")||function(e){var t=l(eB(e));return d?tF(t,d(e)):t},tb=function(e,t,n){for(var i=t_(t),o=0;o<i.length;o++){var s=i[o];ej(e,s)||n&&ej(n,s)||a(e,s,r(t,s))}};var tN={},tA=/#|\.prototype\./,tD=function(e,t){var r=tR[tC(e)];return r===tU||r!==tW&&(Q(t)?$(t):!!t)},tC=tD.normalize=function(e){return String(e).replace(tA,".").toLowerCase()},tR=tD.data={},tW=tD.NATIVE="N",tU=tD.POLYFILL="P";tN=tD,/*
...
tQ=function(e,t){return eh(e),void 0===t?e:O?tK(e,t):function(){return e.apply(t,arguments)}};var tX={};tX=et("document","documentElement");var tZ={};tZ=q([].slice);var t0={},t1=TypeError;t0=function(e,t){if(e<t)throw t1("Not enough arguments");return e};var t2={};// eslint-disable-next-line redos/no-vulnerable -- safe
t2=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t9={};t9="process"===A(k.process);var t4=k.setImmediate,t3=k.clearImmediate,t7=k.process,t8=k.Dispatch,t5=k.Function,t6=k.MessageChannel,re=k.String,rt=0,rr={},rn="onreadystatechange";$(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
k.postMessage(re(e),p.protocol+"//"+p.host)};t4&&t3||(t4=function(e){t0(arguments.length,1);var t=Q(e)?e:t5(e),r=tZ(arguments,1);return rr[++rt]=function(){tz(t,void 0,r)},f(rt),rt},t3=function(e){delete rr[e]},t9?f=function(e){t7.nextTick(ro(e))}:t8&&t8.now?f=function(e){t8.now(ro(e))}:t6&&!t2?(g=(h=new t6).port2,h.port1.onmessage=ra,f=tQ(g.postMessage,g)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&p&&"file:"!==p.protocol&&!$(rs)?(f=rs,k.addEventListener("message",ra,!1)):f=rn in eC("script")?function(e){tX.appendChild(eC("script"))[rn]=function(){tX.removeChild(this),ri(e)}}:function(e){setTimeout(ro(e),0)});var rc=(tG={set:t4,clear:t3}).clear;// `clearImmediate` method
...
(this.arg=t),g}},e}({});try{regeneratorRuntime=rg}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rg:Function("r","regeneratorRuntime = r")(rg)}const rv="https://forkify-api.herokuapp.com/api/v2/recipes/",ry="e4ca5630-7837-440d-85aa-4c87471a46c8",rm=async function(e,t){try{// 1. Loading recipe from API
...
...t.key&&{key:t.key}}},rw=async function(e){try{let t=await rm(`${rv}${e}?key=${ry}`);rb.recipe=r_(t),rb.bookmarks.some(t=>t.id===e)?rb.recipe.bookmarked=!0:rb.recipe.bookmarked=!1}catch(e){throw console.error(e),e}},rk=async function(e){try{rb.search.query=e;// get and make another object of search results
let t=await rm(`${rv}?search=${e}&key=${ry}`);rb.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rb.search.page=1}catch(e){throw e}},rE=function(e=rb.search.page){// the current page
rb.search.page=e;// to set starting point of the pagination
let t=(e-1)*rb.search.resultsPerPage,r=e*rb.search.resultsPerPage;//0
return rb.search.results.slice(t,r)},rS=function(e){rb.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rb.recipe.servings;// newQt = oldQt * newServings / oldServings //example: 2 * 8 / 4 = 4
...
let t=rb.bookmarks.findIndex(t=>t.id===e);rb.bookmarks.splice(t,1),e===rb.recipe.id&&(rb.recipe.bookmarked=!1),r$()},rL=async function(e){try{// making a new array of ingredients, filtering those ingredients
let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format.");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rm(`${rv}?key=${ry}`,r);// adding the new recipe in our state object
rb.recipe=r_(n),// add bookmark in our new recipe
rj(rb.recipe)}catch(e){throw e}};!function(){let e=localStorage.getItem("bookmarks");e&&(rb.bookmarks=JSON.parse(e))}();class rM{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}//   publisher subscriber pattern for search controller
addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rx=new rM,rP={};rP=new URL(_("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rT{// all properties and methods will be available to its child class
_data;/**
...
let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let e=`
    ...
    <div class="message">
        ...
        <p>${e}</p>
      </div>`;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",t)}}var rI={};//FRACTY REDUCES THE FRACTION.
function rq(e,t,r,n,i){var o,a,s;let c=[2,3,5];//If the numerator isn't from a repeating decimal case, the initialized array of prime numbers will suffice to find the common denominators.
...
return rq(n,i,t,r,!1);//Reduce the numerator and denominator.
...
return rq(u,(c-1)*a,n,i,!0);//Further reduce the numerator and denominator.
}(r,n,e,o,t);//Begin calculating the numerator and denominator for decimals that have a pattern.
}};class rH extends rT{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_successMessage="";_generateMarkup(){return`<figure class="recipe__fig">
      ...
      <div class="recipe__details">
        ...
        <button class="btn--round btn--bookmark">
          <svg class="">
            <use href="${/*@__PURE__*/y(rP)}#icon-bookmark${this._data.bookmarked?"-fill":""}"></use>
          </svg>
        </button>
      </div>
      ...
      <div class="recipe__directions">
        ...
        >
          ...
          <svg class="search__icon">
            ...
            <div class="recipe__quantity">${e.quantity?/*@__PURE__*/y(rI)(ing.quantity).toString():""}</div>
...
}}var rF=new rH,rN=new class extends rT{// ul.results in html
_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`    
        ...
        `}};class rA extends rT{// ul.results in html
_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again!";_successMessage="";_generateMarkup(){return this._data.map(e=>rN.render(e,!1)).join("")}}var rD=new rA;class rC extends rT{_parentElement=document.querySelector(".pagination");// event delegation
...
(console.log(this._data.results),1===e&&t>1)?`<button data-goto="${e+1}" class="btn--inline pagination__btn--next">
        ...
        </button>`:"")}}var rR=new rC;class rW extends rT{// ul.results in html
_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it.";_successMessage="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rN.render(e,!1)).join("")}}var rU=new rW;class rG extends rT{_parentElement=document.querySelector(".upload");_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");_successMessage="Recipe was successfully uploaded!";constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}// pagination
_generateMarkup(){this._data.page}}var rz=new rG;const rB=document.querySelector(".recipe"),rY=async function(){try{// to get the id in the url bar
let e=window.location.hash.slice(1);if(!e)return;rF.renderSpinner(rB),rD.update(rE()),rU.update(rb.bookmarks),// loading recipe from model
await rw(e),rF.render(rb.recipe)}catch(e){rF.renderError()}};rY();const rJ=async function(){try{// 1. Get search query
let e=rx.getQuery();if(!e)return;rD.renderSpinner(),// 2. Load search results
await rk(e),rD.render(rE()),rR.render(rb.search)}catch(e){throw e}},rQ=async function(e){try{rz.renderSpinner(),// upload new recipe
await rL(e),rF.render(rb.recipe),rU.render(rb.bookmarks),// change ID in the url
window.history.pushState(null,"",`#${rb.recipe.id}`),rz.renderMessage(),// close the form window
setTimeout(function(){rz.toggleWindow()},2500)}catch(e){rz.renderError(e.message)}};rU.addHandlerRender(function(){rU.render(rb.bookmarks)}),rF.addHandleRender(rY),rF.addHandlerAddBookmark(function(){rb.recipe.bookmarked?rO(rb.recipe.id):rj(rb.recipe),rF.update(rb.recipe),rU.render(rb.bookmarks)}),rF.addHandlerUpdateServings(function(e){// update the recipe servings (in state)
rS(e),rF.update(rb.recipe)}),rx.addHandlerSearch(rJ),rR.addHandlerClick(function(e){rD.render(rE(e)),rR.render(rb.search)}),rz.addHandlerUpload(rQ);//# sourceMappingURL=index.b2007c15.js.map

//# sourceMappingURL=index.b2007c15.js.map
