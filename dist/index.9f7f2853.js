...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;M=F?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var q={};q=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var I={},H={},N={},A=Function.prototype,D=A.call,C=F&&A.bind.bind(D,D),R={},W=(N=F?C:function(e){return function(){return D.apply(e,arguments)}})({}.toString),z=N("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=N("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
B=function(e){if(J(e))throw Y("Can't call method on "+e);return e},I=function(e){return H(B(e))};var Q={},V={},K={},X={},Z={},ee="object"==typeof document&&document.all,et=(Z={all:ee,IS_HTMLDDA:void 0===ee&&void 0!==ee}).all;// `IsCallable` abstract operation
...
ew=function(e,t){var r,n;if("string"===t&&X(r=e.toString)&&!K(n=M(r,e))||X(r=e.valueOf)&&!K(n=M(r,e))||"string"!==t&&X(r=e.toString)&&!K(n=M(r,e)))return n;throw ek("Can't convert object to primitive value")};var eE={},eS={};eS=!1;var eO={},ej={},e$=Object.defineProperty;ej=function(e,t){try{e$(O,e,{value:t,configurable:!0,writable:!0})}catch(r){O[e]=t}return t};var eL="__core-js_shared__";eO=O[eL]||ej(eL,{}),(eE=function(e,t){return eO[e]||(eO[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.1",mode:eS?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.1/LICENSE",source:"https://github.com/zloirock/core-js"});var eM={},eF={},ex=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
eF=function(e){return ex(B(e))};var eP=N({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eM=Object.hasOwn||function(e,t){return eP(eF(e),t)};var eT={},eq=0,eI=Math.random(),eH=N(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eH(++eq+eI,36)};var eN=O.Symbol,eA=eE("wks"),eD=ea?eN.for||eN:eN&&eN.withoutSetter||eT,eC=TypeError,eR=(eM(eA,e="toPrimitive")||(eA[e]=es&&eM(eN,e)?eN[e]:eD("Symbol."+e)),eA[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
V=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=M(n,e,t),!K(r)||en(r))return r;throw eC("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
...
var eB=Object.getOwnPropertyDescriptor;i=$?eB:function(e,t){if(e=I(e),t=Q(t),eW)try{return eB(e,t)}catch(e){}if(eM(e,t))return q(!M(o,e,t),e[t])};var eJ={},eY={};// V8 ~ Chrome 36-
...
eQ=function(e){if(K(e))return e;throw eK(eV(e)+" is not an object")};var eX=TypeError,eZ=Object.defineProperty,e0=Object.getOwnPropertyDescriptor,e1="enumerable",e2="configurable",e4="writable";c=$?eY?function(e,t,r){if(eQ(e),t=Q(t),eQ(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e4 in r&&!r[e4]){var n=e0(e,t);n&&n[e4]&&(e[t]=r.value,r={configurable:e2 in r?r[e2]:n[e2],enumerable:e1 in r?r[e1]:n[e1],writable:!1})}return eZ(e,t,r)}:eZ:function(e,t,r){if(eQ(e),t=Q(t),eQ(r),eW)try{return eZ(e,t,r)}catch(e){}if("get"in r||"set"in r)throw eX("Accessors not supported");return"value"in r&&(e[t]=r.value),e},eJ=$?function(e,t,r){return c(e,t,q(1,r))}:function(e,t,r){return e[t]=r,e};var e3={},e7={},e8=Function.prototype,e9=$&&Object.getOwnPropertyDescriptor,e5=eM(e8,"name")&&(!$||$&&e9(e8,"name").configurable),e6={},te=N(Function.toString);X(eO.inspectSource)||(eO.inspectSource=function(e){return te(e)}),e6=eO.inspectSource;var tt={},tr={},tn=O.WeakMap;tr=X(tn)&&/native code/.test(String(tn));var ti={},to=eE("keys");ti=function(e){return to[e]||(to[e]=eT(e))};var ta={};ta={};var ts="Object already initialized",tc=O.TypeError,tu=O.WeakMap;if(tr||eO.state){var tl=eO.state||(eO.state=new tu);/* eslint-disable no-self-assign -- prototype methods protection */tl.get=tl.get,tl.has=tl.has,tl.set=tl.set,/* eslint-enable no-self-assign -- prototype methods protection */u=function(e,t){if(tl.has(e))throw tc(ts);return t.facade=e,tl.set(e,t),t},l=function(e){return tl.get(e)||{}},d=function(e){return tl.has(e)}}else{var tp=ti("state");ta[tp]=!0,u=function(e,t){if(eM(e,tp))throw tc(ts);return t.facade=e,eJ(e,tp,t),t},l=function(e){return eM(e,tp)?e[tp]:{}},d=function(e){return eM(e,tp)}}var tf=(tt={set:u,get:l,has:d,enforce:function(e){return d(e)?l(e):u(e,{})},getterFor:function(e){return function(t){var r;if(!K(t)||(r=l(t)).type!==e)throw tc("Incompatible receiver, "+e+" required");return r}}}).enforce,th=tt.get,tv=String,tg=Object.defineProperty,tm=N("".slice),ty=N("".replace),tb=N([].join),t_=$&&!L(function(){return 8!==tg(function(){},"length",{value:8}).length}),tw=String(String).split("String"),tk=e7=function(e,t,r){"Symbol("===tm(tv(t),0,7)&&(t="["+ty(tv(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!eM(e,"name")||e5&&e.name!==t)&&($?tg(e,"name",{value:t,configurable:!0}):e.name=t),t_&&r&&eM(r,"arity")&&e.length!==r.arity&&tg(e,"length",{value:r.arity});try{r&&eM(r,"constructor")&&r.constructor?$&&tg(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tf(e);return eM(n,"source")||(n.source=tb(tw,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tk(function(){return X(this)&&th(this).source||e6(this)},"toString"),e3=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(X(r)&&e7(r,o,n),n.global)i?e[t]=r:ej(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:c(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var tE={},tS={},tO={},tj={},t$={},tL={},tM=Math.ceil,tF=Math.floor;// `Math.trunc` method
...
tj=function(e,t){var r=t$(e);return r<0?tx(r+t,0):tP(r,t)};var tT={},tq={},tI=Math.min;// `ToLength` abstract operation
// https://tc39.es/ecma262/#sec-tolength
tq=function(e){return e>0?tI(t$(e),9007199254740991):0;// 2 ** 53 - 1 == 9007199254740991
},// `LengthOfArrayLike` abstract operation
// https://tc39.es/ecma262/#sec-lengthofarraylike
tT=function(e){return tq(e.length)};// `Array.prototype.{ indexOf, includes }` methods implementation
var tH=function(e){return function(t,r,n){var i,o=I(t),a=tT(o),s=tj(n,a);// Array#includes uses SameValueZero equality algorithm
...
indexOf:tH(!1)}.indexOf,tA=N([].push);tO=function(e,t){var r,n=I(e),i=0,o=[];for(r in n)!eM(ta,r)&&eM(n,r)&&tA(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eM(n,r=t[i++])&&(~tN(o,r)||tA(o,r));return o};var tD=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tO(e,tD)},f=Object.getOwnPropertySymbols;var tC=N([].concat);// all object keys, includes non-enumerable and symbols
tS=ei("Reflect","ownKeys")||function(e){var t=p(eQ(e));return f?tC(t,f(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eM(e,a)||r&&eM(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tJ||r!==tB&&(X(t)?L(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tJ=tz.POLYFILL="P";tR=tz,/*
...
tZ=function(e,t){return em(e),void 0===t?e:F?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t4={};t4=N([].slice);var t3={},t7=TypeError;t3=function(e,t){if(e<t)throw t7("Not enough arguments");return e};var t8={};// eslint-disable-next-line redos/no-vulnerable -- safe
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t3(arguments.length,1);var t=X(e)?e:rr(e),r=t4(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t9?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t8?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rp=(tY={set:t5,clear:t6}).clear;// `clearImmediate` method
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rb}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rb:Function("r","regeneratorRuntime = r")(rb)}const r_="https://forkify-api.herokuapp.com/api/v2/recipes/",rw="e4ca5630-7837-440d-85aa-4c87471a46c8",rk=async function(e,t){try{// 1. Loading recipe from API
...
...t.key&&{key:t.key}}},rO=async function(e){try{let t=await rk(`${r_}${e}?key=${rw}`);rE.recipe=rS(t),rE.bookmarks.some(t=>t.id===e)?rE.recipe.bookmarked=!0:rE.recipe.bookmarked=!1}catch(e){throw console.error(e),e}},rj=async function(e){try{rE.search.query=e;// get and make another object of search results
let t=await rk(`${r_}?search=${e}&key=${rw}`);rE.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rE.search.page=1}catch(e){throw e}},r$=function(e=rE.search.page){// the current page
rE.search.page=e;// to set starting point of the pagination
let t=(e-1)*rE.search.resultsPerPage,r=e*rE.search.resultsPerPage;//0
return rE.search.results.slice(t,r)},rL=function(e){rE.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rE.recipe.servings;// newQt = oldQt * newServings / oldServings //example: 2 * 8 / 4 = 4
}),rE.recipe.servings=e},rM=function(){localStorage.setItem("bookmarks",JSON.stringify(rE.bookmarks))},rF=function(e){// Add bookmark
rE.bookmarks.push(e),e.id===rE.recipe.id&&(rE.recipe.bookmarked=!0),rM()},rx=function(e){// Delete bookmark
let t=rE.bookmarks.findIndex(t=>t.id===e);rE.bookmarks.splice(t,1),e===rE.recipe.id&&(rE.recipe.bookmarked=!1),rM()},rP=async function(e){try{// making a new array of ingredients, filtering those ingredients
let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format.");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rk(`${r_}?key=${rw}`,r);// adding the new recipe in our state object
rE.recipe=rS(n),// add bookmark in our new recipe
rF(rE.recipe)}catch(e){throw e}};!function(){let e=localStorage.getItem("bookmarks");e&&(rE.bookmarks=JSON.parse(e))}();class rT{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}//   publisher subscriber pattern for search controller
addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rq=new rT,rI={};rI=new URL(E("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rH{// all properties and methods will be available to its child class
_data;/**
...
this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{// to select all current element in the site
let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let e=`
    <div class="spinner">
      <svg>
        <use href="${/*@__PURE__*/_(rI)}#icon-loader"></use>
      </svg>
...
},y=Fraction;class rN extends rH{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_successMessage="";_generateMarkup(){return`<figure class="recipe__fig">
      ...
      <div class="recipe__directions">
        ...
        >
          ...
          <svg class="search__icon">
            <use href="${/*@__PURE__*/_(rI)}#icon-arrow-right"></use>
          </svg>
        </a>
      </div>`}_generateMarkupIngredient(e){return`<li class="recipe__ingredient">
            <svg class="recipe__icon">
              <use href="${/*@__PURE__*/_(rI)}#icon-check"></use>
            </svg>
...
}}var rA=new rN,rD=new class extends rH{// ul.results in html
_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`    
        ...
        `}};class rC extends rH{// ul.results in html
_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again!";_successMessage="";_generateMarkup(){return this._data.map(e=>rD.render(e,!1)).join("")}}var rR=new rC;class rW extends rH{_parentElement=document.querySelector(".pagination");// event delegation
...
(console.log(this._data.results),1===e&&t>1)?`<button data-goto="${e+1}" class="btn--inline pagination__btn--next">
          ...
          <svg class="search__icon">
            ...
            <svg class="search__icon">
              <use href="${/*@__PURE__*/_(rI)}#icon-arrow-left"></use>
            </svg>
            <span>Page ${e-1}</span>
        </button>`:e<t?`
        ...
        </button>`:"")}}var rz=new rW;class rU extends rH{// ul.results in html
_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it.";_successMessage="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rD.render(e,!1)).join("")}}var rG=new rU;class rB extends rH{_parentElement=document.querySelector(".upload");_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");_successMessage="Recipe was successfully uploaded!";constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}// pagination
_generateMarkup(){this._data.page}}var rJ=new rB;const rY=document.querySelector(".recipe"),rQ=async function(){try{// to get the id in the url bar
let e=window.location.hash.slice(1);if(!e)return;rA.renderSpinner(rY),rR.update(r$()),rG.update(rE.bookmarks),// loading recipe from model
await rO(e),rA.render(rE.recipe)}catch(e){rA.renderError()}};rQ();const rV=async function(){try{// 1. Get search query
let e=rq.getQuery();if(!e)return;rR.renderSpinner(),// 2. Load search results
await rj(e),rR.render(r$()),rz.render(rE.search)}catch(e){throw e}},rK=async function(e){try{rJ.renderSpinner(),// upload new recipe
await rP(e),rA.render(rE.recipe),rG.render(rE.bookmarks),// change ID in the url
window.history.pushState(null,"",`#${rE.recipe.id}`),rJ.renderMessage(),// close the form window
setTimeout(function(){rJ.toggleWindow()},2500)}catch(e){rJ.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rA.addHandleRender(rQ),rA.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rx(rE.recipe.id):rF(rE.recipe),rA.update(rE.recipe),rG.render(rE.bookmarks)}),rA.addHandlerUpdateServings(function(e){// update the recipe servings (in state)
rL(e),rA.update(rE.recipe)}),rq.addHandlerSearch(rV),rz.addHandlerClick(function(e){rR.render(r$(e)),rz.render(rE.search)}),rJ.addHandlerUpload(rK);//# sourceMappingURL=index.9f7f2853.js.map

//# sourceMappingURL=index.9f7f2853.js.map
